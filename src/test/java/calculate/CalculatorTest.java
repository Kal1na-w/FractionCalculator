...
public class CalculatorTest {
    ...
    public void calculatorTest() {
        ...
        assertEquals("No valid expression",calculator.calculate("1/7 + 2 * (2/7 + 3/7 + 7/7 * 1/7#) / 2"));assertEquals("-47/42",calculator.calculate("((1/2) + (2/3)) - ((2/7) : (1/8))"));
        ...
        assertEquals("3/8",calculator.calculate("1/(2/(3/(4)))"));
    }
